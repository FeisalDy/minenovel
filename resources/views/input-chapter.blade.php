...
<div class="container">
    ...
    <table class="table table-striped">
        <thead>
            <tr>
                <th style="width:75%;" scope="col">Judul</th>
                <th style="width:15%;" scope="col">Chapter</th>
                <th style="width:10%;" scope="col" class="text-right">
                    <h1>
                        <a href="{{ route('deletechapter', ['novelId' => $data2->id])  }}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?')" class="fa fa-trash text-danger" style="text-decoration: none;" aria-hidden="true"></a>
                    </h1>
                </th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="max-width:700px; word-wrap:break-word;">
                    <a href="{{ route('inputchapter', ['novelId' => $item->title]) }}" class="text-dark" style="text-decoration: none;">{{$item->title}}</a>
                </td>
                @enddesktop
                @mobile
